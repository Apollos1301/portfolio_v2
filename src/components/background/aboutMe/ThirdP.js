...
function ThirdP() {
  return (
    <div className="w-[60%] p-10 bg-secondaryBackground border-b-2 border-border rounded-md drop-shadow-md">
      <p className="border-b-2 border-border pb-[10%] pt-[10%]">
        ...
        These hobbies help me experience new cultures, experiment with cuisines,
